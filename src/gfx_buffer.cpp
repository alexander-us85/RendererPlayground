...
namespace vr
{
     ...
     */
    VkDeviceSize GfxBuffer::getAlignment(VkDeviceSize instanceSize, VkDeviceSize minOffsetAlignment)
    {
    ...
    GfxBuffer::GfxBuffer(Device& device, VkDeviceSize instanceSize, uint32_t instanceCount, VkBufferUsageFlags usageFlags,
        VkMemoryPropertyFlags memoryPropertyFlags, VkDeviceSize minOffsetAlignment)
        : lveDevice{ device }, instanceSize{ instanceSize }, instanceCount{ instanceCount }, usageFlags{ usageFlags },
     ...
     *
     */
    void GfxBuffer::writeToBuffer(void* data, VkDeviceSize size, VkDeviceSize offset)
    {
     ...
     */
    VkDescriptorBufferInfo GfxBuffer::descriptorInfo(VkDeviceSize size, VkDeviceSize offset)
    {
