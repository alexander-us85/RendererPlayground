...
namespace vr
{
    ...
    DescriptorPool::Builder& vr::DescriptorPool::Builder::addPoolSize(VkDescriptorType descriptorType, uint32_t count)
    {
        poolSizes.push_back({ descriptorType, count });
        return *this;
    }

    DescriptorPool::Builder& vr::DescriptorPool::Builder::setPoolFlags(VkDescriptorPoolCreateFlags flags)
    {
        poolFlags = flags;
        return *this;
    }

    DescriptorPool::Builder& vr::DescriptorPool::Builder::setMaxSets(uint32_t count)
    {
        maxSets = count;
        return *this;
    }
    ...
    bool DescriptorPool::allocateDescriptor(const VkDescriptorSetLayout descriptorSetLayout, VkDescriptorSet& descriptor) const
    {
        ...
        // TODO: Maybe build a new pool when the old one fills up.
